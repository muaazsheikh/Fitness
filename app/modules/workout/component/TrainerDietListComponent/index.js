...
import RatingContainer from "../../../memberDiet/view/component/ratingComponent";
import ViewModal from "../modal/view/ViewModal";
import shareMemberApi from "../../../../api/member-diet/shareMember";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View>
          <View
            style={[styles.headerClick, { width: scale(90), marginLeft: 10 }]}
          >
            <FastImage
